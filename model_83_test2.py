...
class Learner():
    ...
    def learn(self, fol):
        tbCallBack = keras.callbacks.TensorBoard(log_dir='../Graph_test5_fold%d' % fol, \
                            histogram_freq=0, write_graph=True, write_images=True)
        checkpointer = ModelCheckpoint(filepath='/data/tmpsrt1/log_new/weights_test5_fold%d.{epoch:02d}.hdf5' % fol, \
