...
class Learner():
    ...
    def learn(self, fol):
        tbCallBack = keras.callbacks.TensorBoard(log_dir='../Graph_test14_fold%d' % fol, \
                            histogram_freq=0, write_graph=True, write_images=True)
        checkpointer = ModelCheckpoint(filepath='/data/tmpsrt1/log_new/weights_test14_fold%d.{epoch:02d}.hdf5' % fol, \
    ...
    def create_mfcc(self):
        ...
        pre2_2 = MaxPooling2D(pool_size = (2, 2))(pre2_2_b)
        ...
        conv_4_1 = Conv_4_1(mfcc_2_r)
        conv_4_1_b = BatchNormalization()(conv_4_1)
        conv_4_2 = Conv_4_2(conv_4_1_b)
        ...
        in1_conv_3_4 = in1_conv_3_3

        in1_conv_4_4 = conv_4_d
        in1_conv_4_2 = MaxPooling2D(pool_size = (2, 2))(in1_conv_4_4)
        in1_conv_4_1 = MaxPooling2D(pool_size = (2, 2))(in1_conv_4_2)
        in1_conv_4_3 = in1_conv_4_4
        ...
        conv_4_in_1 = Dropout(0.2)(conv_4_in_1_d)
        ...
        Conv_4_7 = Conv2D(size, (K_n, K_n), padding='same', activation='relu')
        Conv_4_8 = Conv2D(size, (K_n, K_n), padding='same', activation='relu')

        conv_1_7 = Conv_1_7(conv_1_in_1)
        conv_1_7_b = BatchNormalization()(conv_1_7)
        conv_1_8 = Conv_1_8(conv_1_7_b)
        conv_1_8_b = BatchNormalization()(conv_1_8)

        conv_2_7 = Conv_2_7(conv_2_in_1)
        conv_2_7_b = BatchNormalization()(conv_2_7)
        conv_2_8 = Conv_2_8(conv_2_7_b)
        conv_2_8_b = BatchNormalization()(conv_2_8)

        conv_3_7 = Conv_3_7(conv_3_in_1)
        conv_3_7_b = BatchNormalization()(conv_3_7)
        conv_3_8 = Conv_3_8(conv_3_7_b)
        conv_3_8_b = BatchNormalization()(conv_3_8)

        conv_4_7 = Conv_4_7(conv_4_in_1)
        conv_4_7_b = BatchNormalization()(conv_4_7)
        conv_4_8 = Conv_4_8(conv_4_7_b)
        conv_4_8_b = BatchNormalization()(conv_4_8)

        lam_1 = Lambda(lam, output_shape=(16, size))(conv_1_8_b)
        lam_2 = Lambda(lam, output_shape=(32, size))(conv_2_8_b)
        lam_3 = Lambda(lam, output_shape=(64, size))(conv_3_8_b)
        lam_4 = Lambda(lam, output_shape=(64, size))(conv_4_8_b)
        ...
        self.model = Model(inputs = [mfcc_2, mfcc_3], outputs = [den_1_2, den_2_2, den_3_2, den_4_2])
    ...
    def predict(self):
        ...
        for aaa in range(15, 40, 5):
            acc = []
            for fol in range(3, 4):
                filename = '/data/tmpsrt1/log_new/weights_test10_fold%d.%02d.hdf5' % (fol, aaa)
