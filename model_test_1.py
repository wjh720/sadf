...
class Learner():
    ...
    def learn(self):
        tbCallBack = keras.callbacks.TensorBoard(log_dir='../Graph_test_1', histogram_freq=0, write_graph=True, write_images=True)
        checkpointer = ModelCheckpoint(filepath='/data/tmpsrt1/log_new/test_1', period = 5, verbose = 1,save_weights_only = True)
