...
class Learner():
    ...
    def learn(self):
        tbCallBack = keras.callbacks.TensorBoard(log_dir='../Graph_7778_test_4', histogram_freq=0, write_graph=True, write_images=True)
        checkpointer = ModelCheckpoint(filepath='/data/tmpsrt1/log_new/test_4_weights.{epoch:02d}-{val_loss:.2f}.hdf5', \
    ...
    def create_mfcc(self):
        ...
        Conv0__1_1 = Conv2D(64, (K_n, K_n), padding='same', activation='relu')
        Conv0__1_2 = Conv2D(64, (K_n, K_n), padding='same', activation='relu')
        Conv0__1_3 = Conv2D(64, (K_n, K_n), padding='same', activation='relu')
        Conv0__2_1 = Conv2D(64, (K_n, K_n), padding='same', activation='relu')
        Conv0__2_2 = Conv2D(64, (K_n, K_n), padding='same', activation='relu')
        Conv0__2_3 = Conv2D(64, (K_n, K_n), padding='same', activation='relu')
        Conv0__3_1 = Conv2D(64, (K_n, K_n), padding='same', activation='relu')
        Conv0__3_2 = Conv2D(64, (K_n, K_n), padding='same', activation='relu')
        Conv0__3_3 = Conv2D(64, (K_n, K_n), padding='same', activation='relu')

        Conv1__1_1 = Conv2D(64, (K_n, K_n), padding='same', activation='relu')
        Conv1__1_2 = Conv2D(64, (K_n, K_n), padding='same', activation='relu')
        Conv1__1_3 = Conv2D(64, (K_n, K_n), padding='same', activation='relu')
        Conv1__2_1 = Conv2D(64, (K_n, K_n), padding='same', activation='relu')
        Conv1__2_2 = Conv2D(64, (K_n, K_n), padding='same', activation='relu')
        Conv1__2_3 = Conv2D(64, (K_n, K_n), padding='same', activation='relu')
        Conv1__3_1 = Conv2D(64, (K_n, K_n), padding='same', activation='relu')
        Conv1__3_2 = Conv2D(64, (K_n, K_n), padding='same', activation='relu')
        Conv1__3_3 = Conv2D(64, (K_n, K_n), padding='same', activation='relu')

        Conv2__1_1 = Conv2D(64, (K_n, K_n), padding='same', activation='relu')
        Conv2__1_2 = Conv2D(64, (K_n, K_n), padding='same', activation='relu')
        Conv2__1_3 = Conv2D(64, (K_n, K_n), padding='same', activation='relu')
        Conv2__2_1 = Conv2D(64, (K_n, K_n), padding='same', activation='relu')
        Conv2__2_2 = Conv2D(64, (K_n, K_n), padding='same', activation='relu')
        Conv2__2_3 = Conv2D(64, (K_n, K_n), padding='same', activation='relu')
        Conv2__3_1 = Conv2D(64, (K_n, K_n), padding='same', activation='relu')
        Conv2__3_2 = Conv2D(64, (K_n, K_n), padding='same', activation='relu')
        Conv2__3_3 = Conv2D(64, (K_n, K_n), padding='same', activation='relu')

        Conv3__1_1 = Conv2D(64, (K_n, K_n), padding='same', activation='relu')
        Conv3__1_2 = Conv2D(64, (K_n, K_n), padding='same', activation='relu')
        Conv3__1_3 = Conv2D(64, (K_n, K_n), padding='same', activation='relu')
        Conv3__2_1 = Conv2D(64, (K_n, K_n), padding='same', activation='relu')
        Conv3__2_2 = Conv2D(64, (K_n, K_n), padding='same', activation='relu')
        Conv3__2_3 = Conv2D(64, (K_n, K_n), padding='same', activation='relu')
        Conv3__3_1 = Conv2D(64, (K_n, K_n), padding='same', activation='relu')
        Conv3__3_2 = Conv2D(64, (K_n, K_n), padding='same', activation='relu')
        Conv3__3_3 = Conv2D(64, (K_n, K_n), padding='same', activation='relu')
        ...
        conv_1_2_a = Conv_1_2(conv_1_1)
        conv_1_2 = Conv0__1_1(conv_1_2_a)
        conv_2_1 = Conv_2_1(mfcc_2_r)
        conv_2_2_a = Conv_2_2(conv_2_1)
        conv_2_2 = Conv0__2_2(conv_2_2_a)
        conv_3_1 = Conv_3_1(mfcc_3_r)
        conv_3_2_a = Conv_3_2(conv_3_1)
        conv_3_2 = Conv0__3_3(conv_3_2_a)
        ...
        conv_1_4_a = Conv_1_4(conv_1_3)
        conv_1_4 = Conv1__1_1(conv_1_4_a)
        conv_2_3 = Conv_2_3(conv_2_in_1)
        conv_2_4_a = Conv_2_4(conv_2_3)
        conv_2_4 = Conv1__2_2(conv_2_4_a)
        conv_3_3 = Conv_3_3(conv_3_in_1)
        conv_3_4_a = Conv_3_4(conv_3_3)
        conv_3_4 = Conv1__3_3(conv_3_4_a)
        ...
        conv_1_6_a = Conv_1_6(conv_1_5)
        conv_1_6 = Conv2__1_1(conv_1_6_a)
        conv_2_5 = Conv_2_5(conv_2_in_2)
        conv_2_6_a = Conv_2_6(conv_2_5)
        conv_2_6 = Conv2__2_2(conv_2_6_a)
        conv_3_5 = Conv_3_5(conv_3_in_2)
        conv_3_6_a = Conv_3_6(conv_3_5)
        conv_3_6 = Conv2__3_3(conv_3_6_a)
        ...
        conv_1_8_a = Conv_1_8(conv_1_7)
        conv_1_8 = Conv3__1_1(conv_1_8_a)
        conv_2_7 = Conv_2_7(conv_2_in_3)
        conv_2_8_a = Conv_2_8(conv_2_7)
        conv_2_8 = Conv3__2_2(conv_2_8_a)
        conv_3_7 = Conv_3_7(conv_3_in_3)
        conv_3_8_a = Conv_3_8(conv_3_7)
        conv_3_8 = Conv3__3_3(conv_3_8_a)
