...
class Learner():
    ...
    def learn(self):
        ...
        checkpointer = ModelCheckpoint(filepath='/data/tmpsrt1/log_new/', save_best_only=True, period = 10, \
    ...
    def create_mfcc(self):
        ...
        lam_1 = Lambda(lam, output_shape=(64, 128))(conv_1_8)
        lam_2 = Lambda(lam, output_shape=(64, 128))(conv_2_8)
        lam_3 = Lambda(lam, output_shape=(64, 128))(conv_3_8)
