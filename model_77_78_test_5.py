...
class Learner():
    ...
    def learn(self):
        tbCallBack = keras.callbacks.TensorBoard(log_dir='../Graph_77_test_5', histogram_freq=0, write_graph=True, write_images=True)
        checkpointer = ModelCheckpoint(filepath='/data/tmpsrt1/log_new/test_5_weights.{epoch:02d}-{val_loss:.2f}.hdf5', \
    ...
    def create_mfcc(self):
        ...
        lam_2 = Lambda(lam, output_shape=(16, 64))(conv_2_8)
        lam_3 = Lambda(lam, output_shape=(16, 64))(conv_3_8)
