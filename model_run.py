...
class Learner():
    ...
    def learn(self):
        tbCallBack = keras.callbacks.TensorBoard(log_dir='../Graph_run', histogram_freq=0, write_graph=True, write_images=True)
        checkpointer = ModelCheckpoint(filepath='/data/tmpsrt1/log_new/run', period = 5, verbose = 1,save_weights_only = True)
    ...
    def create_mfcc(self):
        ...
        conv_1_1_a = Conv_1_1(mfcc_1_r)
        conv_1_1 = Dropout(0.1)(conv_1_1_a)
        conv_1_2_a = Conv_1_2(conv_1_1)
        conv_2_1_a = Conv_2_1(mfcc_2_r)
        conv_2_1 = Dropout(0.1)(conv_2_1_a)
        conv_2_2_a = Conv_2_2(conv_2_1)
        conv_3_1_a = Conv_3_1(mfcc_3_r)
        conv_3_1 = Dropout(0.1)(conv_3_1_a)
        ...
        conv_1_3_a = Conv_1_3(conv_1_in_1)
        conv_1_3 = Dropout(0.1)(conv_1_3_a)
        conv_1_4_a = Conv_1_4(conv_1_3)
        conv_2_3_a = Conv_2_3(conv_2_in_1)
        conv_2_3 = Dropout(0.1)(conv_2_3_a)
        conv_2_4_a = Conv_2_4(conv_2_3)
        conv_3_3_a = Conv_3_3(conv_3_in_1)
        conv_3_3 = Dropout(0.1)(conv_3_3_a)
        ...
        conv_1_5_a = Conv_1_5(conv_1_in_2)
        conv_1_5 = Dropout(0.1)(conv_1_5_a)
        conv_1_6_a = Conv_1_6(conv_1_5)
        conv_2_5_a = Conv_2_5(conv_2_in_2)
        conv_2_5 = Dropout(0.1)(conv_2_5_a)
        conv_2_6_a = Conv_2_6(conv_2_5)
        conv_3_5_a = Conv_3_5(conv_3_in_2)
        conv_3_5 = Dropout(0.1)(conv_3_5_a)
        ...
        conv_1_7_a = Conv_1_7(conv_1_in_3)
        conv_1_7 = Dropout(0.1)(conv_1_7_a)
        conv_1_8_a = Conv_1_8(conv_1_7)
        conv_2_7_a = Conv_2_7(conv_2_in_3)
        conv_2_7 = Dropout(0.1)(conv_2_7_a)
        conv_2_8_a = Conv_2_8(conv_2_7)
        conv_3_7_a = Conv_3_7(conv_3_in_3)
        conv_3_7 = Dropout(0.1)(conv_3_7_a)
        ...
        den_1_1_a = Dense_1_1(fla_1)
        den_1_1 = Dropout(0.1)(den_1_1_a)
        den_1_2 = Dense_1_2(den_1_1)
        den_2_1_a = Dense_2_1(fla_2)
        den_2_1 = Dropout(0.1)(den_2_1_a)
        den_2_2 = Dense_2_2(den_2_1)
        den_3_1_a = Dense_3_1(fla_3)
        den_3_1 = Dropout(0.1)(den_3_1_a)
